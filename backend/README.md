...
## Project Structure
    ...
    ├── arplo_brain_express_43263  # Django project configurations
...
1. Clone this repo and `cd arplo_brain_express_43263`
...
2. Clone this repo and `cd arplo_brain_express_43263`
